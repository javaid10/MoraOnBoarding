        ...
        try {
            ...
            if (preprocess(request, result)) {
                ...
                if (appId != "") {
                    ...
                    inputContract.put("in_day", dayOfWeek); // day of week
                    ...
                    inputContract.put("account_name", "SABB");// needs change
                    ...
                    inputContract.put("total_amount_to_be_paid", "115 SAR"); // need change Total payable (Profit + Loan
                                                                             // amt)
                    ...
                    inputContract.put("due_date_of_first_installment_one", monthlyRepay); // need change First
                                                                                          // instalment Date
                    inputContract.put("due_date_of_last_installment_one", monthlyRepay); // need change Last instalment
                                                                                         // Date
                    ...
                    inputContract.put("product_type", "copper"); // need change
                    inputContract.put("payment_period", monthlyRepay); // emi
                    inputContract.put("product_spacification", "copper"); // need change
                    ...
                    String res = DBPServiceExecutorBuilder.builder().withServiceId("MSDocumentMora")
                            .withOperationId("LoanContract").withRequestParameters(inputContract).build().getResponse();
                    ...
                    if (!file.isEmpty()) {
                        ...
                        String contractRes = DBPServiceExecutorBuilder.builder().withServiceId("DBMoraServices")
                                .withOperationId("dbxdb_document_storage_create").withRequestParameters(inputMap)
                                .build().getResponse();
                    }
